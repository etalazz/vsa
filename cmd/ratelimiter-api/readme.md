...
- -commit_threshold int
  Batch size before persisting; higher = fewer database writes, but slightly older stored state. Example: -commit_threshold=50
...
Tip: Choose these based on your datastore budget and freshness needs. Higher commit_threshold and longer commit_interval reduce DB load; lower values persist more frequently.
